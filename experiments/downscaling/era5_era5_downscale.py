...
parser.add_argument("--ratio", type=int, default=2, help="The downscaling ratio, from (32, 64) to (64, 128)") # downscaling ratio
...
ORO_PATH = '/home/chang/climate_datasets/era5/constants_2.8125/orography.npz' # the elevation information, change according to target size
...
if args.preset == "vit":
    ...
    optim_kwargs = {"lr": args.lr, "weight_decay": 1e-4, "betas": (0.9, 0.99)} #0.95
    sched_kwargs = {
        "warmup_epochs": 10,
        "max_epochs": args.max_epochs,
        "warmup_start_lr": 1e-6,
...
default_root_dir = f"{args.preset}_downscaling_{args.variable}_era5_{args.ratio}x_{current_time}"
